...
class MethodNodeSpec extends ObjectBehavior
{
    ...
    public function it_has_an_empty_return_type_by_default()
    {
        $this->getReturnTypeNode()->shouldBeLike(new ReturnTypeNode());
    }

    public function it_can_modify_return_type()
    {
    ...
    public function it_can_modify_return_type_as_strings_using_deprecated_methods()
    {
