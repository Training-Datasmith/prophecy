...
class UnionTypeSpec extends ObjectBehavior
{
    ...
    public function it_throws_double_exception_when_union_type_given(): void
    {
        $this->beConstructedWith([
    ...
    public function it_throws_double_exception_when_types_duplicated(): void
    {
        $this->beConstructedWith([new BuiltinType('string'), new BuiltinType('string')]);
        $this->shouldThrow(DoubleException::class)->duringInstantiation();
    }

    public function it_throws_double_exception_when_union_with_void(): void
    {
        $this->beConstructedWith([new BuiltinType('void'), new BuiltinType('string')]);
        $this->shouldThrow(DoubleException::class)->duringInstantiation();
    }

    public function it_throws_double_exception_when_union_with_never(): void
    {
        $this->beConstructedWith([new BuiltinType('never'), new BuiltinType('string')]);
        $this->shouldThrow(DoubleException::class)->duringInstantiation();
    }

    public function it_throws_double_exception_when_union_with_mixed(): void
    {
        $this->beConstructedWith([new BuiltinType('mixed'), new BuiltinType('string')]);
        $this->shouldThrow(DoubleException::class)->duringInstantiation();
    }

    public function it_throws_double_exception_when_union_with_only_one_type(): void
    {
        $this->beConstructedWith([new BuiltinType('string')]);
        $this->shouldThrow(DoubleException::class)->duringInstantiation();
    }

    public function it_return_array_of_its_types(): void
    {
    ...
    public function it_should_accept_simple_type_and_intersection()
    {
